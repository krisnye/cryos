...
describe("DenseVolume.pick", () => {
    ...
    describe("picking from different directions", () => {
        ...
        it("should pick from diagonal direction", () => {
            ...
            const centerIndex = DenseVolume.getIndex({ type: "dense", size: [3, 3, 3], data: createTypedBuffer(Material.Id.schema, data) }, 1, 1, 1);
    ...
    describe("different volume sizes", () => {
        ...
        it("should work with flat 10x10x1 volume", () => {
            ...
            const targetIndex = DenseVolume.getIndex({ type: "dense", size: [10, 10, 1], data: createTypedBuffer(Material.Id.schema, data) }, 5, 5, 0);
        ...
        it("should work with large 20x20x20 volume", () => {
            ...
            const targetIndex = DenseVolume.getIndex({ type: "dense", size: [20, 20, 20], data: createTypedBuffer(Material.Id.schema, data) }, 10, 10, 10);
