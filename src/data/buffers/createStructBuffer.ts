...
import { createDataView32, DataView32 } from "../DataView32";
import { InferType, Schema } from "../Schema";
import { createReadStruct } from "./structs/createReadStruct";
import { createWriteStruct } from "./structs/createWriteStruct";
...
export const createStructBuffer = <S extends Schema, ArrayType extends keyof DataView32 = "f32">(
    ...
    const buffer: TypedBuffer<InferType<S>, DataView32[ArrayType]> = {
        ...
        set length(length: number) {
            ...
            arrayBuffer = ArrayBufferLike_grow(arrayBuffer, length * layout.size, true);
