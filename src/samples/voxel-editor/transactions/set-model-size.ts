    ...
    for (let x = -1; x <= width; x++) {
        for (let y = -1; y <= height; y++) {
            t.archetypes.Wall.insert({
                ...
                position: [x + offset, y + offset, depth + offset],
                color: WALL_COLOR,
                scale: [1, 1, 1],
    ...
    for (let x = -1; x <= width; x++) {
        for (let y = -1; y <= height; y++) {
            t.archetypes.Wall.insert({
                ...
                position: [x + offset, y + offset, -1 + offset],
                color: WALL_COLOR,
                scale: [1, 1, 1],
                rotation: Quat.identity,
            });
    ...
    for (let y = -1; y <= height; y++) {
        for (let z = -1; z <= depth; z++) {
            t.archetypes.Wall.insert({
                ...
                position: [width + offset, y + offset, z + offset],
                color: WALL_COLOR,
                scale: [1, 1, 1],
                rotation: Quat.identity,
            });
    ...
    for (let y = -1; y <= height; y++) {
        for (let z = -1; z <= depth; z++) {
            t.archetypes.Wall.insert({
                ...
                position: [-1 + offset, y + offset, z + offset],
                color: WALL_COLOR,
                scale: [1, 1, 1],
                rotation: Quat.identity,
            });
    ...
    for (let x = -1; x <= width; x++) {
        for (let z = -1; z <= depth; z++) {
            t.archetypes.Wall.insert({
                ...
                position: [x + offset, height + offset, z + offset],
                color: WALL_COLOR,
                scale: [1, 1, 1],
                rotation: Quat.identity,
            });
    ...
    for (let x = -1; x <= width; x++) {
        for (let z = -1; z <= depth; z++) {
            t.archetypes.Wall.insert({
                ...
                position: [x + offset, -1 + offset, z + offset],
                color: WALL_COLOR,
                scale: [1, 1, 1],
                rotation: Quat.identity,
            });
