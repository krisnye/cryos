...
describe("pickMaterialVolumeModels", () => {
    ...
    it("should pick a single MaterialVolumeModel", () => {
        const db = Database.create(Database.Plugin.combine(graphics, materialVolumeModel));
        ...
        const result = pickMaterialVolumeModels(db, line);
    ...
    it("should return null when no MaterialVolumeModels exist", () => {
        const db = Database.create(Database.Plugin.combine(graphics, materialVolumeModel));
